          ...
          {visibleReviews.map((review, index) => (
            ...
            >
              <div className="flex items-center justify-between gap-4">
                ...
                <div className="inline-flex min-h-9 items-center rounded-full border border-[color-mix(in_oklab,var(--line)_90%,transparent)] bg-[color-mix(in_oklab,var(--surface-strong)_92%,transparent)] px-3 text-[0.92rem] text-[var(--text)]">
              ...
              <div className="mt-auto h-px w-full bg-[linear-gradient(90deg,color-mix(in_oklab,var(--accent)_70%,transparent),transparent_78%)]" />
            </article>
          ))}
        </div>
      </div>
